...
# from what compose/compose-core.yaml mounts; skipped, loudly, if it resolves to nothing or
...
# is left untouched, so rollback is reverting compose/compose-core.yaml *and rebuilding
