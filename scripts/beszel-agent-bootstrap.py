...
def restart_agent_if_needed(agent_env: AgentEnv) -> None:
    ...
    # compose/compose-monitoring.yaml - not the service name `beszel-agent`, which never appears in
...
def main() -> int:
    ...
    # compose/compose-monitoring.yaml sets DISABLE_PASSWORD_AUTH=true, so this is the normal path:
