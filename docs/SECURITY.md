...
The two Stremio addons keep their own, in `config/aiostreams/aiostreams.env` and
...
and data n8n hands out for execution. Like the Vaultwarden secret it is machine-to-machine, so
